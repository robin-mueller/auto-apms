...
if(DEFINED _AUTO_APMS_BEHAVIOR_TREE__CREATOR_PLUGIN_XML_CONTENT)
    file(GENERATE
        OUTPUT "${PROJECT_BINARY_DIR}/${_AUTO_APMS_BEHAVIOR_TREE_BUILD_DIR_RELATIVE}/${PROJECT_NAME}_creator_plugins.xml"
        CONTENT "<class_libraries>\n${_AUTO_APMS_BEHAVIOR_TREE__CREATOR_PLUGIN_XML_CONTENT}</class_libraries>"
    )
    install(
        FILES
        "${PROJECT_BINARY_DIR}/${_AUTO_APMS_BEHAVIOR_TREE_BUILD_DIR_RELATIVE}/${PROJECT_NAME}_creator_plugins.xml"
        DESTINATION
        "${_AUTO_APMS_BEHAVIOR_TREE_RESOURCES_DIR_RELATIVE}"
    )
    ament_index_register_resource(
        "${_AUTO_APMS_BEHAVIOR_TREE__RESOURCE_TYPE_NAME__CREATOR}"
        CONTENT
        "${_AUTO_APMS_BEHAVIOR_TREE_RESOURCES_DIR_RELATIVE}/${PROJECT_NAME}_creator_plugins.xml"
    )
endif()
