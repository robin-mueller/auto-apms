...
if(DEFINED _AUTO_APMS_BEHAVIOR_TREE__NODE_PLUGIN_XML_CONTENT)
    file(GENERATE
        OUTPUT "${PROJECT_BINARY_DIR}/${_AUTO_APMS_BEHAVIOR_TREE_BUILD_DIR_RELATIVE}/node_plugins.xml"
        CONTENT "<class_libraries>\n${_AUTO_APMS_BEHAVIOR_TREE__NODE_PLUGIN_XML_CONTENT}</class_libraries>"
    )
    install(
        FILES
        "${PROJECT_BINARY_DIR}/${_AUTO_APMS_BEHAVIOR_TREE_BUILD_DIR_RELATIVE}/node_plugins.xml"
        DESTINATION
        "${_AUTO_APMS_BEHAVIOR_TREE_RESOURCES_DIR_RELATIVE}/${_AUTO_APMS_BEHAVIOR_TREE__RESOURCE_DIR_NAME__NODE}"
    )
    ament_index_register_resource(
        "${_AUTO_APMS_BEHAVIOR_TREE__RESOURCE_TYPE_NAME__NODE}"
        CONTENT
        "${_AUTO_APMS_BEHAVIOR_TREE_RESOURCES_DIR_RELATIVE}/${_AUTO_APMS_BEHAVIOR_TREE__RESOURCE_DIR_NAME__NODE}/node_plugins.xml"
    )
endif()
