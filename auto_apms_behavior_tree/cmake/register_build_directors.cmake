...
macro(auto_apms_behavior_tree_register_build_directors target)
    if(NOT TARGET ${target})
        message(
        FATAL_ERROR
        "auto_apms_behavior_tree_register_build_directors(): '${target}' is not a target.")
    endif()
    ...
    if(NOT _target_type STREQUAL "SHARED_LIBRARY")
        message(
        FATAL_ERROR
        "auto_apms_behavior_tree_register_build_directors(): '${target}' is not a shared library target.")
    endif()
    ...
    foreach(_class_name ${ARGS_UNPARSED_ARGUMENTS})
        if(${_class_name} IN_LIST _AUTO_APMS_BEHAVIOR_TREE__BUILD_DIRECTOR_CLASS_NAMES)
            message(
            FATAL_ERROR
            "auto_apms_behavior_tree_register_build_directors(): Class name '${_class_name}' has already been registered before.")
        endif()
