...
VehicleCommandClient::SendCommandResult VehicleCommandClient::SyncSendVehicleCommand(uint32_t command, float param1,
                                                                                     float param2, float param3,
                                                                                     float param4, float param5,
                                                                                     float param6, float param7) const
{
...
VehicleCommandClient::SendCommandResult
VehicleCommandClient::SyncSendVehicleCommand(const px4_msgs::msg::VehicleCommand& cmd) const
{
...
bool VehicleCommandClient::Takeoff(float altitude_amsl_m, float heading_rad) const
{
  ...
  return !SyncSendVehicleCommand(VehicleCommand::VEHICLE_CMD_NAV_TAKEOFF, NAN, NAN, NAN, heading_rad, NAN, NAN,
                                 altitude_amsl_m);
}

bool VehicleCommandClient::Land() const
{
