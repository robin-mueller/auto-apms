...
${_error}"
    ...
    if(NOT "${ARGS_NODE_MODEL_HEADER_TARGET}" STREQUAL "")
        ...
        # We do not add ament_target_dependencies("${ARGS_NODE_MODEL_HEADER_TARGET}" auto_apms_behavior_tree_core)
...
We highly recommend adding one of these packages to ${ARGS_NODE_MODEL_HEADER_TARGET}'s dependencies and export it (!) to make it easier for downstream packages to use the behavior tree node model header generated by this macro:
ament_target_dependencies(${ARGS_NODE_MODEL_HEADER_TARGET}
    ... # Other packages
