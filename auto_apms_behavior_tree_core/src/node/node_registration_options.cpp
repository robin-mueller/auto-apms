...
const std::string NodeRegistrationOptions::PARAM_NAME_ROS2TOPIC = _AUTO_APMS_BEHAVIOR_TREE_CORE__NODE_MANIFEST_PARAM_ROS2TOPIC;
const std::string NodeRegistrationOptions::PARAM_NAME_DESCRIPTION = _AUTO_APMS_BEHAVIOR_TREE_CORE__NODE_MANIFEST_PARAM_DESCRIPTION;
const std::string NodeRegistrationOptions::PARAM_NAME_PORT_ALIAS = _AUTO_APMS_BEHAVIOR_TREE_CORE__NODE_MANIFEST_PARAM_PORT_ALIAS;
const std::string NodeRegistrationOptions::PARAM_NAME_PORT_DEFAULT = _AUTO_APMS_BEHAVIOR_TREE_CORE__NODE_MANIFEST_PARAM_PORT_DEFAULT;
...
const std::string NodeRegistrationOptions::PARAM_NAME_HIDDEN_PORTS = _AUTO_APMS_BEHAVIOR_TREE_CORE__NODE_MANIFEST_PARAM_HIDDEN_PORTS;
