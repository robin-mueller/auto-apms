...
class HaltExecutorAction : public RosActionNode<px4_behavior_interfaces::action::BTExecutorCommand>
{
   public:
...
CreateRosNodePlugin(px4_behavior::HaltExecutorAction, NODE_NAME);
