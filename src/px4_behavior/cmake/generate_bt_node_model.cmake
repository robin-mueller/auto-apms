...
macro(px4_behavior_generate_bt_node_model config_yaml_source_path)
    ...
    add_custom_command(OUTPUT "${_model_build_path}"
        COMMAND "${_PX4_BEHAVIOR_EXECUTABLES_INSTALL_DIR}/generate_bt_node_model"
            ...
            "${ARGS_EXTRA_PLUGIN_DIR}" # Absolute directory where the extra plugin libraries are stored.
        WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        DEPENDS "${config_yaml_source_path}" ${_all_bt_plugin_targets}
        COMMENT "Executing command to generate model definition: ${_PX4_BEHAVIOR_EXECUTABLES_INSTALL_DIR}/generate_bt_node_model ${config_yaml_source_path} ${_model_build_path} ${ARGS_EXTRA_PLUGIN_DIR}")
    ...
    install(
        ...
        DESTINATION "share/${_PX4_BEHAVIOR_RESOURCES_DIR_NAME}/model")
endmacro()
