...
#include "auto_apms/bt_node_registration.hpp"
    ...
    for (const auto& plugin_config : plugin_config_paths) {
        ...
        for (YAML::const_iterator it = root.begin(); it != root.end(); ++it) {
            ...
            for (YAML::const_iterator it = plugins_node.begin(); it != plugins_node.end(); ++it) {
                ...
                const std::string factory_classname = "auto_apms::BTNodeRegistrationTemplate<" + plugin_classname + ">";
                ...
                auto plugin_instance = loader->createInstance<auto_apms::BTNodeRegistration>(factory_classname);
