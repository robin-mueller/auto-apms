...
void ContingencyManagerExecutor::SetupBehaviorTreeFactory(
...
ContingencyManagerExecutor::Command ContingencyManagerExecutor::ReviewControlCommand(
  Command current_command, State current_state)
{
...
{
  RCLCPP_INFO(
    node()->get_logger(), "Contingency Manager wakes up due to event %s",
