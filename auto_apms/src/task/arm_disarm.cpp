...
#include "auto_apms/vehicle_command_client.hpp"
#include "px4_msgs/msg/vehicle_status.hpp"

namespace auto_apms {

class ArmDisarmTask : public TaskBase<auto_apms_interfaces::action::ArmDisarm>
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(auto_apms::ArmDisarmTask)
